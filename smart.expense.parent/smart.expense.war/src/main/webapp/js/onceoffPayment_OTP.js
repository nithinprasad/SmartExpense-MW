function externalBeneficiaryImmediateOTP() {
	var inputJson = {
...
function internalBeneficiaryImmediateOTP() {
	var inputJson = {
		Ver: "MessageEnvelope_1.0.0",
		Resource: "resrc",
		AppVer: "1.0.0",
...
function onceOffPaymentBusinessNameOTP() {
	var inputJson = {
		Ver: "MessageEnvelope_1.0.0",
		Resource: "resrc",
		AppVer: "1.0.0",
...
function oNceOffPaymentSTPPaymentOTP() {
	var inputJson = {
		Ver: "MessageEnvelope_1.0.0",
		Resource: "resrc",
		AppVer: "1.0.0",
...
function oNceOffBillerImmediateOTP() {
	var inputJson = {
		Ver: "MessageEnvelope_1.0.0",
		Resource: "resrc",
		AppVer: "1.0.0",
...
function oNceOffBillerScheduledOTP() {
	var inputJson = {
		Ver: "MessageEnvelope_1.0.0",
		Resource: "resrc",
		AppVer: "1.0.0",
...
function oNceOffBeneficaryScheduledOTP() {
	var inputJson = {
		Ver: "MessageEnvelope_1.0.0",
		Resource: "resrc",
		AppVer: "1.0.0",
